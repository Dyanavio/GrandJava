...
public class Student {
    ...
    public Student(String fullName, LocalDate birthDate, List<Integer> homeworkGrades, List<Integer> examGrades)
    {
        setFullName(fullName);
        setBirthDate(birthDate);
        this.homeworkGrades = new ArrayList<>();
        ...
        this.homeworkGrades.addAll(homeworkGrades);
        this.examGrades.addAll(examGrades);
    }
